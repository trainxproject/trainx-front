...
//           <button className="bg-(--card) hover:bg-(--primary) px-4 py-2 rounded-xl"
//           onClick={() => handlerAllUser()}>
//             Todos
//           </button>
//           <button className="bg-(--card) hover:bg-(--primary) px-4 py-2 rounded-xl"
//           onClick={() => hanlderFilter("active")}>
//             Activios
//           </button>
//           <button className="bg-(--card) hover:bg-(--primary) px-4 py-2 rounded-xl"
//           onClick={() => hanlderFilter("inactive")}>
//             Inactivos
//           </button>
//         </div>
...
const UserStatsCard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-(--background) mt-10 px-4 sm:px-6 lg:px-10">
      ...
      <div className="flex justify-around items-center w-md bg-(--secondary) py-3 rounded-2xl">
      <button
          onClick={() => {hanlderFilter("active"), setActiveFilter("all")}}
      ...
      <button
          onClick={() => {hanlderFilter("active"), setActiveFilter("inactive")}}
          className={`px-4 py-2 rounded-xl 
